...
difference() {
	union() {
		translate(v = [-20.5000000000, 0.0000000000, -4.5000000000]) {
			cube(size = [41, 3, 9]);
		}
		translate(v = [-20.5000000000, -15.0000000000, -4.5000000000]) {
			cube(size = [3, 15, 9]);
		}
		translate(v = [17.5000000000, -15.0000000000, -4.5000000000]) {
			cube(size = [3, 15, 9]);
		}
	}
	union() {
